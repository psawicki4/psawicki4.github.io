...
`+F_(s.getShaderSource(e),a)}else return i}function k_(s,e){let t=B_(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function z_(s,e){let t;switch(e){case Pu:t="Linear";break;case Lu:t="Reinhard";break;case Du:t="Cineon";break;case Nu:t="ACESFilmic";break;case Ou:t="AgX";break;case Fu:t="Neutral";break;case Uu:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var bo=new I;function V_(){He.getLuminanceCoefficients(bo);let s=bo.x.toFixed(4),e=bo.y.toFixed(4),t=bo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Ir).join(`
`)),a=Kc(a),a=Sd(a,t),a=Td(a,t),o=Kc(o),o=Sd(o,t),o=Td(o,t),a=wd(a),o=wd(o),t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+f);let T=w+m+a,M=w+f+o,L=vd(i,i.VERTEX_SHADER,T),C=vd(i,i.FRAGMENT_SHADER,M);i.attachShader(x,L),i.attachShader(x,C),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function E(P){if(s.debug.checkShaderErrors){let G=i.getProgramInfoLog(x).trim(),k=i.getShaderInfoLog(L).trim(),Z=i.getShaderInfoLog(C).trim(),K=!0,X=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(K=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,L,C);else{let $=bd(i,L,"vertex"),z=bd(i,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
